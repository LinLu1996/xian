...
import  '../chinesetmsproviders/leaflet.ChineseTmsProviders';
//坐标参考系统
export const crs = new CRS(
    'EPSG:900913',
...
//     }
// );
export const gaodeTileLayer = L.tileLayer.chinaProvider(
    'GaoDe.Normal.Map',
    {
        maxZoom: 20,
        minZoom: 5
...
export const gaodeSeaTileLayer = L.tileLayer.chinaProvider(
    'GaoDe.Satellite.Map',
    {
        maxZoom: 20,
        minZoom: 5
