...
class SearchTree extends Component {
  ...
  onChange(e) {
    ...
    if(value) {
        ...
        this.setState({
            ...
            autoExpandParent: false,
            expandedKeys:[],
            showTreeData:this.props.TreeParent
          });
    }
    }
    add(record,e) {
  ...
  render() {
    ...
    searchValue ? data = showTreeData: expandedKeys.length>0 ||  searchflag? data=this.props.TreeDatalist: data = this.props.TreeParent;
    return (
